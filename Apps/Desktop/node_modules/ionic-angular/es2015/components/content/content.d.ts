...
export declare class Content extends Ion implements OnDestroy, OnInit {
    ...
    constructor(config: Config, _plt: Platform, _dom: DomController, elementRef: ElementRef, renderer: Renderer, _app: App, _keyboard: Keyboard, _zone: NgZone, viewCtrl: ViewController, _tabs: Tabs);
    /**
     * @private
     */
    ngOnInit(): void;
