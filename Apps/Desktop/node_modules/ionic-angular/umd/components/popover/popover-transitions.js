...
(function (factory) {
    ...
    var PopoverPopIn = (function (_super) {
        ...
        PopoverPopIn.prototype.init = function () {
            ...
            var wrapper = new animation_1.Animation(this.plt, ele.querySelector('.popover-wrapper'));
    ...
    var PopoverMdPopIn = (function (_super) {
        ...
        PopoverMdPopIn.prototype.init = function () {
            var ele = this.enteringView.pageRef().nativeElement;
            var content = new animation_1.Animation(this.plt, ele.querySelector('.popover-content'));
            var viewport = new animation_1.Animation(this.plt, ele.querySelector('.popover-viewport'));
