...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../app/app', '../../config/config', '../../platform/dom-controller', '../ion', '../../util/util', '../../platform/keyboard', '../../platform/platform', '../../util/scroll-view', '../tabs/tabs', '../../navigation/view-controller'], factory);
    }
    ...
    var Content = (function (_super) {
        ...
        function Content(config, _plt, _dom, elementRef, renderer, _app, _keyboard, _zone, viewCtrl, _tabs) {
            var _this = this;
             ...
             */
            this.ionScrollStart = new core_1.EventEmitter();
            /**
             * @output {ScrollEvent} Emitted on every scroll event.
             */
            this.ionScroll = new core_1.EventEmitter();
            /**
             * @output {ScrollEvent} Emitted when scrolling ends.
             */
            this.ionScrollEnd = new core_1.EventEmitter();
            ...
            this._scroll = new scroll_view_1.ScrollView(_plt, _dom);
            if (viewCtrl) {
