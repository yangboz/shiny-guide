(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../../util/util', './item', '../list/list', '../../platform/platform', '../../platform/dom-controller'], factory);
    }
    ...
    var ItemSliding = (function () {
        function ItemSliding(list, _plt, _dom, _renderer, _elementRef, _zone) {
            this._plt = _plt;
            this._dom = _dom;
            this._renderer = _renderer;
            this._elementRef = _elementRef;
