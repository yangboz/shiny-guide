(function (factory) {
    ...
    var VirtualScroll = (function () {
        ...
        VirtualScroll.prototype.writeUpdate = function () {
            (void 0) /* console.debug */;
            virtual_util_1.processRecords(this._data.renderHeight, this._records, this._cells, this._hdrFn, this._ftrFn, this._data);
            // ******** DOM WRITE ****************
            this.renderVirtual();
        };
        VirtualScroll.prototype._hasChanges = function () {
            return (util_1.isPresent(this._records) && util_1.isPresent(this._differ) && util_1.isPresent(this._differ.diff(this._records)));
        };
        /**
         * @private
         * DOM WRITE
        ...
        VirtualScroll.prototype.renderVirtual = function () {
            ...
            virtual_util_1.populateNodeData(0, data.bottomCell, data.viewWidth, true, cells, records, nodes, this._itmTmp.viewContainer, this._itmTmp.templateRef, this._hdrTmp && this._hdrTmp.templateRef, this._ftrTmp && this._ftrTmp.templateRef, true);
            // ******** DOM WRITE ****************
        ...
        VirtualScroll.prototype.scrollUpdate = function (ev) {
            ...
            if (this._queue === SCROLL_QUEUE_DOM_WRITE) {
                ...
                if (Math.abs(data.scrollDiff) > SCROLL_DIFFERENCE_MINIMUM) {
                    ...
                    var hasChanges = virtual_util_1.populateNodeData(data.topCell, data.bottomCell, data.viewWidth, data.scrollDiff > 0, cells, this._records, nodes, this._itmTmp.viewContainer, this._itmTmp.templateRef, this._hdrTmp && this._hdrTmp.templateRef, this._ftrTmp && this._ftrTmp.templateRef, false);
                    if (hasChanges) {
